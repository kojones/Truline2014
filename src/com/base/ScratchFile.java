...
public class ScratchFile
{
  ...
  */
 public static void init(Properties userProps, String file)
 {
  m_scr.m_filename = file + ".scr";
  /*
   * String string; string = userProps.getProperty("SCRFILE"); if
   * (!string.equals(m_scr.m_filename)) { m_scr.m_filename = string;
   */
  /*
