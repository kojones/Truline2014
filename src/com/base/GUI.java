...
public class GUI extends Frame implements ActionListener, Runnable
{
 ...
 public void init()
 {
  ...
  if (Truline.userProps.getProperty("Experimental", "N").equals("Y")) {
   ...
   MenuItem printFlowBets = new MenuItem("Print Flow Bets");
  ...
  MenuItem aboutMenuItem = new MenuItem("About Truline2012");
 ...
 public void actionPerformed(ActionEvent e)
 {
  ...
  if (cmd.equals("next")) {
   ...
   Dialog dlg = new Dialog(this, "About Truline2012", true);
