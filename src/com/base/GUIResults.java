...
for (Enumeration e = race.m_posts.elements(); e.hasMoreElements();) {
 ...
 switch (m_horse) {
  case 1:
   horse1 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse1);
   continue;
  case 2:
   horse2 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse2);
   continue;
  case 3:
   horse3 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse3);
   continue;
  case 4:
   horse4 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse4);
   continue;
  case 5:
   horse5 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse5);
   continue;
  case 6:
   horse6 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse6);
   continue;
  case 7:
   horse7 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse7);
   continue;
  case 8:
   horse8 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse8);
   continue;
  case 9:
   horse9 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse9);
   continue;
  case 10:
   horse10 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse10);
   continue;
  case 11:
   horse11 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse11);
   continue;
  case 12:
   horse12 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse12);
   continue;
  case 13:
   horse13 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse13);
   continue;
  case 14:
   horse14 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse14);
   continue;
  case 15:
   horse15 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse15);
   continue;
  case 16:
   horse16 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse16);
   continue;
  case 17:
   horse17 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse17);
   continue;
  case 18:
   horse18 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse18);
   continue;
  case 19:
   horse19 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse19);
   continue;
  case 20:
   horse20 = new TextField(post.m_finishPos, 2);
   setRow(c, gridbag,
     new Label(Lib.pad(post.cloth, 3) + Lib.pad(post.m_horseName, 16)),
     horse20);
   continue;
...
private void saveScratch(Post post)
{
Scratch scr = new Scratch();
scr.m_track = post.m_track;
scr.m_raceDate = post.m_raceDate;
scr.m_raceNo = post.m_raceNo;
scr.m_postPosition = post.m_postPosition;
scr.m_horseName = post.m_horseName;
/* if (Log.isDebug(Log.PARSES)) */
Log.print("Scratch: " + scr.m_track + " " + scr.m_raceDate + " #"
  + scr.m_raceNo + " post=" + scr.m_postPosition + " " + scr.m_horseName
  + "\n\n");
ScratchFile.print(scr.m_track + ',' + scr.m_raceDate + "," + scr.m_raceNo
  + "," + scr.m_postPosition + "," + scr.m_horseName + "\n");
}
}
